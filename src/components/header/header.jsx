...
export default function Header() {
    return (
        <header className="flex items-center p-4 py-6 justify-between gap-8 font-regular">
            ...
            <nav className="hidden lg:flex gap-8 text-lg text-[#025A7B]">
            ...
            <button className='block lg:hidden'>oi</button>
